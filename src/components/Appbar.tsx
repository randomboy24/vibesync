...
export default function AppBar() {
  ...
  return (
    <header className="px-4 lg:px-6 h-16 flex items-center justify-between border-b-[1px] border-white shadow-lg dark:bg-gray-900 backdrop-blur-md transition-colors duration-300 sticky top-0 z-50">
