  ...
  return (
    <header className="px-4 lg:px-6 h-16 flex items-center justify-between border-b shadow-white dark:shadow-black shadow-lg dark:bg-gray-900 backdrop-blur-md transition-colors duration-300 sticky top-0 z-50">
      <Link className="flex items-center justify-center group" href="#">
        ...
        <span className="ml-2 text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 dark:from-purple-400 dark:via-pink-400 dark:to-blue-400 transition-all duration-300 group-hover:tracking-wider" onClick={() => router.push("/")}>VibeSync</span>
      </Link>
